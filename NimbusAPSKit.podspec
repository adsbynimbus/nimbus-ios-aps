Pod::Spec.new do |spec|
    spec.name                   = 'NimbusAPSKit'
    spec.version                = '0.0.1-development'
    spec.summary                = 'Enables APS bidding through Nimbus'
    ...
    spec.source_files           = "Sources/NimbusAPSKit/**/*.swift"
    spec.source                 = {
        :git => "https://github.com/adsbynimbus/nimbus-ios-aps.git", 
        :tag => spec.version.to_s
    }

    spec.dependency 'NimbusSDK/NimbusKit', '~> 3'
    spec.dependency 'AmazonPublisherServicesSDK', '~> 5'
end
